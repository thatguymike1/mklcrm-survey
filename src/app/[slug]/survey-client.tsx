      ...
      <div className="min-h-screen flex flex-col bg-[var(--mkl-page-bg)]">
        ...
        <main className="flex-1 px-4 pt-12 pb-16">
          <div className="w-full max-w-xl mx-auto">
            ...
            {/* Divider */}
            <div className="border-t border-[var(--mkl-border)] mb-12" />

            {/* Exploration */}
            <div className="text-center">
              <h2 className="text-base font-semibold text-[var(--mkl-question)] mb-2">
                Curious how Mike King Live can elevate your next event?
              </h2>
              <p className="text-sm text-[var(--mkl-muted)] mb-6">Optional — explore either experience below.</p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="/assets/booth-tile.png"
                    alt="Booth Engagement"
                    className="w-full h-auto block"
                  />
                </a>
                <a
                  href="https://mikekinglive.com/vip-events"
                  target="_blank"
                  rel="noopener noreferrer"
